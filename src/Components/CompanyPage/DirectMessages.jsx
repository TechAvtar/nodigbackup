...
const DirectMessages = () => {
    const [dirmess,setDirmess] = useState(true)
  return (
    <div>
        {(dirmess) ? (<div className="main-DirMessModal">
            <div className="inside-DirMessModal" >
            <div className="top-DirMessModal" >
  ...
  <defs>
    <clipPath id="clip0_107_1591">
      <rect width="32" height="32" fill="white"/>
              ...
              <div className="bottom-DirMessModal">
                <p className="head-AppointmentModal">Direct Message</p>
                <p className='head2-AppointmentModal'>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                ...
                <div className="col1-AppointmentModal">
                <input type='number' className="email-AppointmentModal" placeholder='Mobile Number*' required />
                </div>
                <div className="col1-AppointmentModal">
                    <div className="submitBtn-DirectMessagesModal">
                        <p>Submit </p>
                    </div>
